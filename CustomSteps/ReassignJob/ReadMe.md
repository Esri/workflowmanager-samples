Reassign Job Custom Step

* * *

This sample demonstrates how to reassign a job.
...
Workflow Manager Install Location\Developer Kit\Samples\CustomSteps\ReassignJob

How to use

1.  <span style="font-family: Verdana, sans-serif; font-size: 8pt;">Open the ReassignJobCS2008 solution using Visual Studio.</span>
...
11.  Your new ReassignJob class should be presented; select it then click OK.

12.  Enter in the required arguments. <spaces> </spaces>This step has two required arguments, for example:

/assignType:group /assignTo:Managers
