Close Job Custom Step

* * *

Demonstrates how to programmatically close a job, update the job status, and send an email notification.
...
Workflow Manager Install Location\Developer Kit\Samples\Custom Steps\CloseJob

How to use

1.  <span style="font-family: Verdana, sans-serif; font-size: 8pt;">Open the CloseJobCS2008 solution using Visual Studio.</span>
...
11.  Your new CloseJob class should be presented; select it then click OK.
