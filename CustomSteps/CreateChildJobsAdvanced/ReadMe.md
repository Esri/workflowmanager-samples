Create Child Job(s) Advanced Custom Step

* * *

Demonstrates how to create new child job(s) with advanced options and an implementation of a step argument editor.
...
1.  <span style="font-family: Verdana, sans-serif; font-size: 8pt;">Open the CreateChildJobsAdvanced solution using Visual Studio.</span>
...
11.  Your new CreateChildJobsAdvanced class should be presented; select it then click OK.

12.  Configure the necessary arguments for this custom step. For example:

/jobtypename:"Street Updates"

14.  Alternatively, use the argument editor to define the step arguments.

<implicit_p>![](CreateChildJobAdvanced_StepTypeProps.png)*   Click Ok to save your new step type.
