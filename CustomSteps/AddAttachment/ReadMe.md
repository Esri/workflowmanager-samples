<span>Add Attachment Custom Step</span>

* * *

This sample demonstrates how to programmatically add an attachment to a job.
...
Workflow Manager Install Location\Developer Kit\Samples\AddAttachment

How to use

1.  <span style="font-family: Verdana, sans-serif; font-size: 8pt;">Open the AddAttachment solution using Visual Studio.</span>
...
11.  Your new AddAttachment class should be presented; select it then click OK.
