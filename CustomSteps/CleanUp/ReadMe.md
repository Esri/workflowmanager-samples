Clean Up Custom Step

* * *

Demonstrates how to delete the job's current version and map document.
...
Workflow Manager Install Location\Developer Kit\Samples\Custom Steps\Clean Up

How to use

1.  <span style="font-family: Verdana, sans-serif; font-size: 8pt;">Open the CleanUpCS2008 solution using Visual Studio.</span>
...
11.  Your new CleanUp class should be presented; select it then click OK.

12.  Configure the arguments for this custom step. For example with the following argument combination, both the job version and map document will be deleted:
