Create PDF Custom Step

* * *

This sample demonstrates retrieving the job's map document and adding attachments to a job.
...
Workflow Manager Install Location\Developer Kit\Samples\CustomSteps\CreatePDF

<span style="font-weight: bold; font-family: Verdana, sans-serif; font-size: 8pt;">How to use</span>

1.  Open the CreatePDFCS2008 solution using Visual Studio.
