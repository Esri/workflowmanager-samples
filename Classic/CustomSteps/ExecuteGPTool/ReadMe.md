Execute Geoprocessing Tool Custom Step

* * *

This samples shows how to silently execute a Geoprocessing tool.
...
Workflow Manager Install Location\Developer Kit\Samples\ExecuteGPTool

How to use

1.  <span style="font-family: Verdana, sans-serif; font-size: 8pt;">Open the ExecuteGPTool solution using Visual Studio.</span>
...
11.  Your new ExecuteGPTool class should be presented; select it then click OK.

12.  Configure any optional arguments for this custom step. For example:

/toolboxpath:"C:\Program Files\ArcGIS\Desktop10.0\ArcToolbox\Toolboxes\Data Management Tools.tbx" /tool:Dissolve /param:in_features:C:\in.shp /param:out_feature_class:C:\out.shp /param:dissolve_field:CountyName /attach
