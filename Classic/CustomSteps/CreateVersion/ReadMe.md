Create Version Custom Step

* * *

This samples shows how to programmatically create a job version.
...
Workflow Manager Install Location\Developer Kit\Samples\CreateVersion

How to use

1.  <span style="font-family: Verdana, sans-serif; font-size: 8pt;">Open the CreateVersionCS2008 solution using Visual Studio.</span>
...
11.  Your new CreateVersion class should be presented; select it then click OK.

12.  Configure any optional arguments for this custom step. For example:

/name:Job[JOB:ID] /scope:protected
