<span>Select Data Workspace Custom Step</span>

* * *

This sample demonstrates finding all the data workspaces currently configured and setting an active data workspace for the current job.
...
11.  Your new SelectDataWorkspace class should be presented; select it then click OK.
